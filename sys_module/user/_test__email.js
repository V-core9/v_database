...
test_username = async () => {
  ...
  console.log(await user_schema.email.validate('De\\mo'));
  console.log(await user_schema.email.validate('Demo\\'));
  console.log(await user_schema.email.validate('Demo_____1'));
  console.log(await user_schema.email.validate('Demo123455367345531231264362352341234123123123123'));
  console.log(await user_schema.email.validate('Demo@@3123'));
  console.log(await user_schema.email.validate('Demo123123'));
  console.log(await user_schema.email.validate('XZCZXCSDAFSAFA'));
  console.log(await user_schema.email.validate('WEQ23652'));
